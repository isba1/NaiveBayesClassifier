...
# Student Name: Ishaan Das
# UW Email    : isdas@ucsc.edu
...
class NaiveBayes():
    ...
    def word_set(self, filename: str):  ## used to be of type list by I changed it to str
        """
    ...
    def fit(self, train_hams: list, train_spams: list):
        ...
        def get_counts(filenames: list, d):
            """
        ...
        get_counts(train_hams, self.word_counts_ham)
